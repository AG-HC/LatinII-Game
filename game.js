  ...
  if (nodeChoice === undefined) {
    ...
    switch (timeline) {
      ...
      case 100:
        ...
        health = 5;
        textElement.innerText+="\nTRIAL COMPLETE\n\nHealth Restored!\n\n";
        if (trials[currentTrial-1] == undefined) {
          textElement.innerText+="\nඞ";
        } else {
...
let trials = [trial1, trial2, trial3, trial4, trial5, trial6, trial7, trial8, trial9, trial10, trial11, trial12];
